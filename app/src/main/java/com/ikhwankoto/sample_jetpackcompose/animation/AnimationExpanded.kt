    ...
    Surface(
        ...
        Column(
            ...
            if (expanded) {
                ...
                Text(
                    text = "Lorem ispum dolar asek ispum dolar asek ispum dolar " +
                            "asek ispum dolar asek ispum dolar asek ispum dolar asek" +
                            " ispum dolar asek ispum dolar asek ispum dolar asek" +
                            " ispum dolar asek ispum dolar asek ispum dolar asek",
...
fun MySpacer(visible: Boolean) {
    AnimatedVisibility(visible = visible) {
        Spacer(modifier = Modifier.height(8.dp).background(Color.Red))
    }
}